...
//                            }
                            ...
                            DisclosureGroup("Computers") {
                                ...
                                NavigationLink(destination: ComputerBasicView(selectedResourceType: ResourceType.computerDetailed, server: server )) {
                                    Text("Computers")
                                }
                                
                         
                                NavigationLink(destination: ComputersActionView( server: server )) {
